...
------------------------------------------------------------------------
myFont :: [Char]
myFont = "xft:Hermit:style=Bold:pixelsize=13"
...
myStartupHook = do
        --Background--
          spawnOnce "xwallpaper --zoom ~/Media/Pictures/Wallpapers/void5.png"
...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
    ...
    where
        ...
        spawnLaunch  = myTerminal ++ " -T launch.sh -e launch.sh"
        findLaunch   = title =? "launch.sh"
        manageLaunch = customFloating $ W.RationalRect l t w h
                       where
                           h = 0.6
                           w = 0.3
                           t = 0.65 -h
        ...
        spawnMenu  = myTerminal ++ " -T logout.sh -e logout.sh"
        findMenu   = title =? "logout.sh"
        manageMenu = customFloating $ W.RationalRect l t w h
                       where
                           h = 0.2
                           w = 0.2
                           t = 0.50 -h
        ...
        manageCalc = customFloating $ W.RationalRect l t w h
                       where
                           ...
                           t = 0.60 -h
                           l = 0.87 -w
        spawnMail  = myTerminal ++ " -T neomutt -e neomutt"
        findMail   = title =? "neomutt"
        ...
        spawnEdit  = myTerminal ++ " -T edit_configs.sh -e edit_configs.sh"
        findEdit   = title =? "edit_configs.sh"
        ...
        spawnVsp  = myTerminal ++ " -T vsp2 -e vsp2"
        findVsp   = title =? "vsp2"
        manageVsp = customFloating $ W.RationalRect l t w h
                       where
                           h = 0.965
                           w = 0.2
                           t = 0.99 -h
...
myKeys =
    ...
    -- Run Prompts
        ...
        , ("M-d", spawn "dmenu_run -p Execute: -g 10 -l 5 -nb '#3b3b3b' -fn 'Roboto' -nf '#000000' -sb '#000000' -sf '#477d8f'")    
    ...
    -- Scratchpads
        ...
        , ("M-S-d", namedScratchpadAction myScratchPads "launch")
        ...
        , ("M-S-e", namedScratchpadAction myScratchPads "edit")
        , ("M-h", namedScratchpadAction myScratchPads "keys")
        , ("M-S-c", namedScratchpadAction myScratchPads "menu")
        , ("M-S-i", namedScratchpadAction myScratchPads "vsp")
